...
public class guessing extends AppCompatActivity {
    ...
    private void randmise() {
        ...
        letters.add('P');
        letters.add('A');
        char rndmLetter1 = 0, rndmLetter2 = 0, rndmLetter3 = 0, rndmLetter4 = 0, rndmLetter5 = 0, rndmLetter6 = 0, rndmLetter7 = 0, rndmLetter8 = 0, rndmLetter9 = 0, rndmLetter10 = 0, rndmLetter11 = 0, rndmLetter12 = 0, rndmLetter13 = 0, rndmLetter14 = 0, rndmLetter15 = 0, rndmLetter16 = 0;
...
//        int randomIndex = rndm.nextInt(letters.size());
//        char randomCharacter = letters.get(randomIndex);
//        letters.remove(randomIndex);


//        char getrndmLetter = getRandomCharacter(letters);
//        String naam  = getmnchr();
//        char unique ;

//        for(int i = 0; i < naam.length(); i++){
//            unique = naam.charAt(i);

    //        }
//       return randomCharacter;
//
//    }
//      public String getmnchr(){
//          String name= wordToGuess;
//          String s = "";
////          List<Character> naam = new ArrayList<>();
//        Set<Character> unchr = new HashSet<>();
//        for (int i = 0; i < name.length(); i++) {
//            unchr.add(name.charAt(i));
//        }
//        for(Character c : unchr){
//                s=s+c;
//        }
//        return s;
//    }
//    public static char getRandomCharacter(char[] letters) {
